...
class RendererSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Sylius\Bundle\ReportBundle\Model\Renderer');
    }

    function it_implements_renderer_interface()
    {
        $this->shouldImplement('Sylius\Bundle\ReportBundle\Model\RendererInterface');
    }
